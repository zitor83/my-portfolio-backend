...
('José Antonio', 'Ortiz Sánchez', 'Java Backend Developer', 'Perfil híbrido que combina la visión estratégica de la Diplomatura en Empresariales con la especialización técnica en desarrollo Backend. Más de 10 años liderando equipos en entornos de alta presión, ahora enfocado en construir arquitecturas robustas con Java y Spring Boot.', 'img/dev-jose.jpeg', 1, 'ortizsanchezjoseantonio@gmail.com', '+34 678 93 70 01', 'https://www.linkedin.com/in/jose-antonio-ortiz-sanchez/', 'https://github.com/zitor83');

INSERT INTO skills (name, level_percentage, icon_class, personal_info_id) VALUES
('Java', 80, 'img/logos/java.png', 1),
('Spring Boot', 70, 'img/logos/spring.svg', 1),
('HTML-5', 85, 'img/logos/html-5.png', 1),
('CSS', 75, 'img/logos/css-3.png', 1),
('JavaScript', 75, 'img/logos/js.png', 1),
('Angular', 65, 'img/logos/angular.png', 1),
('PostgreSQL', 75, 'img/logos/postgre.png', 1),
('Docker', 70, 'img/logos/docker.svg', 1),
('Github', 85, 'img/logos/github.png', 1),
('Liderazgo de Equipos', 95, 'img/logos/equipo.svg', 1),
('Gestión de Negocio', 90, 'img/logos/negocio.svg', 1);
...
('Formación en Inglés', 'Escuela oficial de idiomas', '2002-08-14', '2008-06-30', 'Desarrollo de competencias lingüísticas para entornos profesionales y técnicos.', 1);
